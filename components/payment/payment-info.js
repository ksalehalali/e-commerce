      ...
      <FlexDiv>
        <Radio.Group onChange={onChange} value={paymentType}>
          <FlexDiv>
            <FlexDiv
              margin={5}
              style={{ border: `1px solid ${COLORS.BG_COLOR_GRAY}` }}
              width={240}
              gap={5}
              padding={20}
            >
            ...
            {/* <StyledRibbon
              text={
                <>
                  Available Soon <HourglassOutlined />
                </>
              }
              placement="start"
            > */}
            <FlexDiv
              ...
              gap={5}
            >
              <Radio value={1}>{t("payment:radios.creditPayment")}</Radio>
            </FlexDiv>
            {/* </StyledRibbon> */}
            ...
            <FlexDiv
              ...
              padding={20}
            >
              <Radio value={2}>{t("payment:radios.walletPayment")}</Radio>
            </FlexDiv>
          </FlexDiv>
        </Radio.Group>
      </FlexDiv>
