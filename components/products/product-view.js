      ...
      <FlexDiv gap={10} padding={10}>
        <FlexDiv column gap={10} justifyCenter>
          {activeImagesList?.image1 && (
            <a
              href="#"
              onClick={(e) =>
                changeActiveImageHandler(e, activeImagesList?.image1)
              }
            >
              <SlideImage
                src={
                  process.env.NEXT_PUBLIC_HOST_API + activeImagesList?.image1
                }
                alt={`${data[`name_${router.locale.toLocaleUpperCase()}`]} ${
                  activeImagesList?.color
                }`}
                width={80}
                height={80}
                active={activeImage === activeImagesList?.image1}
              />
            </a>
          )}
          {activeImagesList?.image2 && (
            <a
              href="#"
              onClick={(e) =>
                changeActiveImageHandler(e, activeImagesList?.image2)
              }
            >
              <SlideImage
                src={
                  process.env.NEXT_PUBLIC_HOST_API + activeImagesList?.image2
                }
                alt={`${data[`name_${router.locale.toLocaleUpperCase()}`]} ${
                  activeImagesList?.color
                }`}
                width={80}
                height={80}
                active={activeImage === activeImagesList?.image2}
              />
            </a>
          )}
          {activeImagesList?.image3 && (
            <a
              href="#"
              onClick={(e) =>
                changeActiveImageHandler(e, activeImagesList?.image3)
              }
            >
              <SlideImage
                src={
                  process.env.NEXT_PUBLIC_HOST_API + activeImagesList?.image3
                }
                alt={`${data[`name_${router.locale.toLocaleUpperCase()}`]} ${
                  activeImagesList?.color
                }`}
                width={80}
                height={80}
                active={activeImage === activeImagesList?.image3}
              />
            </a>
          )}
          {activeImagesList?.image4 && (
            <a
              href="#"
              onClick={(e) =>
                changeActiveImageHandler(e, activeImagesList?.image4)
              }
            >
              <SlideImage
                src={
                  process.env.NEXT_PUBLIC_HOST_API + activeImagesList?.image4
                }
                alt={`${data[`name_${router.locale.toLocaleUpperCase()}`]} ${
                  activeImagesList?.color
                }`}
                width={80}
                height={80}
                active={activeImage === activeImagesList?.image4}
              />
            </a>
          )}
        </FlexDiv>
        ...
        <FlexDiv gap={90} spaceBetween>
          ...
          <Text bold color={COLORS.TITLE} as="h1" margin={0}>
            ...
            <FlexDiv gap={10}>
              <Text color={COLORS.TEXT_PRIMARY}>{t("products:size")}</Text>
              <FlexDiv gap={5}>
                {data?.size?.map((item) => (
                  <Button
                    key={item.id}
                    type={item.sizeID === size ? "primary" : ""}
                    onClick={(e) => changeProductSize(e, item.sizeID)}
                  >
                    {item.size}
                  </Button>
                ))}
            ...
            <FlexDiv gap={10}>
              <Text color={COLORS.TEXT_PRIMARY}>{t("products:colors")}</Text>
              <FlexDiv gap={5}>
                {colorList?.map((item) => (
                  <Button
                    key={item.id}
                    type={item.colorID === color ? "primary" : ""}
                    onClick={(e) => changeProductColor(e, item.colorID)}
                  >
                    {item.color}
                  </Button>
                ))}
            ...
            <Button
              ...
              loading={addLoading}
              disabled={isInCart || data?.size?.length === 0 ? true : false}
            >
              {data?.size?.length === 0
